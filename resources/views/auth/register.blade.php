                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-12">
                    <div class="form-head">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-2">
                                                {!! __('I agree to the :terms_of_service and :privacy_policy', [
                                                        'terms_of_service' => '<a target="_blank" href="'.route('terms.show').'" class="underline text-sm  text-red-600 hover:text-red-900">'.__('Terms of Service').'</a>',
                                                        'privacy_policy' => '<a target="_blank" href="'.route('policy.show').'" class="underline text-sm text-red-600 hover:text-red-900">'.__('Privacy Policy').'</a>',
                                                ]) !!}
                                            </div>
                                        </div>
                                    </x-jet-label>
                        ...
                        <p class="outer-link mt-5 text-center">Already have an account?
                            <a href="{{ route('login') }}" class="text-red-700 hover:text-red-400">Login Now</a>
                        </p>
