...
<head>
    ...
    <title>Maplandi Order Notification</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        a {
                                                        ...
                                                        <tr>
                                                            <td align="center" bgcolor="#b10b06"
                                                                style="padding:30px;Margin:0"><p
                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:78px;color:#ffffff;font-size:57px">
                                                                    Maplandi</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr>
                                                            <td align="center"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    ...
                                                                    <a href="mailto:support@maplandi.com">support@maplandi.com.</a>
                                                                </p></td>
                                                        </tr>
                                                    </table>
                                                </td>
